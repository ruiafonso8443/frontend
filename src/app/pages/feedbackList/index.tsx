        ...
        return (
            <>
                <MobileView>
                    ...
                    <Center>
                        <Button marginTop='15%' _focus={{ boxShadow: "none" }} _hover={{ bg: '#A2543D' }} borderColor='#DA8E71' borderRadius='200px' color='#DA8E71'
                            variant='outline' height='47px' width='220px'>BACK TO FEEDBACK</Button>
                    </Center>
                </MobileView>
                ...
                <BrowserView>
                    <SimpleGrid columns={[1, 2]}>
                        ...
                        <Center>
                            <Button marginTop='10%' _focus={{ boxShadow: "none" }} _hover={{ bg: '#A2543D' }} borderColor='#DA8E71' borderRadius='200px' color='#DA8E71'
                                variant='outline' height='47px' width='540px'>BACK TO FEEDBACK</Button>
                        </Center>
